...
public class ListaControladoresPrincipal {
	...
	void abrirTutorial(ActionEvent event) {
		...
		try {
			...
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(ListaControladoresPrincipal.class.getResource("Tutorial.fxml"));
	...
	void abrirInicioCorrecto(ActionEvent event) {
		...
		try {
			...
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(ListaControladoresPrincipal.class.getResource("RootLayout.fxml"));
